package com.greatlearning.security.studentManagementSecurity.controller;
...
import com.greatlearning.security.studentManagementSecurity.service.StudentService;
...
public class StudentsController {
	...
	public String listBooks(Model theModel) {
		...
		List<Student> theBooks = studentService.findAll();

		// add to the spring model
		theModel.addAttribute("Students", theBooks);
